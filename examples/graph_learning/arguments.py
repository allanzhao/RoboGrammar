...
def get_parser():
    ...
    parser.add_argument('--eps-sample-start', type = float, default = 1.0, help = 'starting eps for sampling multiple designs')
    parser.add_argument('--eps-sample-end', type = float, default = 0.0, help = 'ending eps for sampling multiple designs')
    parser.add_argument('--eps-sample-decay', type = float, default = 0.5, help = 'decay factor of eps for sampling multiple designs')
    parser.add_argument('--eps-sample-schedule', type = str, default = 'exp-decay', help = 'eps schedule for sampling multiple designs [eps-decay, linear-decay]')
