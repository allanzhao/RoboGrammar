'''
train_value_prediction.py

use Graph Neural Network to learn a value function for robot terminal designs.
...
if __name__ == '__main__':
    ...
    # dataset path 
    dataset_dir = os.path.join(current_dir, 'data', 'terminal_design_dataset', dataset_name)
    ...
    if not args.test:
        save_dir = os.path.join(current_dir, 'trained_models', 'terminal_value_function', dataset_name, get_time_stamp())
